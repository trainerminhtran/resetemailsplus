...
class Curl
{
    ...
    public function buildPostData($data)
    {
        ...
        if (isset($this->headers['Content-Type']) &&
            ...
            $data = \App\Helper\Utils\Encoder::encodeJson($data);
    ...
    public function post($url, $data = '', $follow_303_with_post = false)
    {
        ...
        var_dump($this->buildPostData($data));
    ...
    {
        $this->jsonDecoder = '\App\Helper\Utils\Decoder::decodeJson';
    ...
    {
        $this->xmlDecoder = '\App\Helper\Utils\Decoder::decodeXml';
    ...
    public function setDefaultDecoder($mixed = 'json')
    {
        if ($mixed === false) {
            ...
            if ($mixed === 'json') {
                $this->defaultDecoder = '\App\Helper\Utils\Decoder::decodeJson';
            } elseif ($mixed === 'xml') {
                $this->defaultDecoder = '\App\Helper\Utils\Decoder::decodeXml';
            }
        }
    }
    /**
