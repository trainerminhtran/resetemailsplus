...
final class Acl
{
    ...
    const PERMISSION_VIEW_MENU_CHARTS = 'view menu shop';
    const PERMISSION_VIEW_MENU_TABLE = 'view menu product';
    const PERMISSION_VIEW_MENU_CLIPBOARD = 'view menu order';
    const PERMISSION_VIEW_MENU_EXCEL = 'view menu chat';
    const PERMISSION_VIEW_MENU_ZIP = 'view menu support';
    const PERMISSION_VIEW_MENU_PDF = 'view menu customer';
    const PERMISSION_VIEW_MENU_ELEMENT_UI = 'view menu store';
    const PERMISSION_VIEW_MENU_COMPONENTS = 'view menu report';
